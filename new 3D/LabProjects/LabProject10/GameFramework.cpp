...
void CGameFramework::BuildObjects()
{
	...
	m_pCamera->GenerateViewMatrix(XMFLOAT3(0.0f, 10.0f, -50.0f), XMFLOAT3(0.0f, 0.0f, 0.0f), XMFLOAT3(0.0f, 1.0f, 0.0f));
...
void CGameFramework::FrameAdvance()
{
	...
	if (m_pScene)
		m_pScene->Render(m_pd3dCommandList, m_pCamera);  //씬그리기
